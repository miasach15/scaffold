...
export default function GroupedTaskRow({ groupTitle, groupDueDate, groupDueStart, remainingItems, doneCount, total, onToggleDone, onSetCategory, onRemove, onOpenDetail, onOpenFocus, onSetDate, onSetStart }) {
