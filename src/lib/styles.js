import { BORDER, MUTED, PRIMARY_DARK, SURFACE } from "./constants";
...
export const ghostBtn = { padding: "8px 14px", borderRadius: 10, border: `1px solid ${BORDER}`, background: SURFACE, fontSize: 13, fontWeight: 600, color: MUTED, whiteSpace: "nowrap" };
...
export const suggestionChip = { padding: "5px 11px", borderRadius: 999, border: `1px dashed ${BORDER}`, background: SURFACE, fontSize: 12, fontWeight: 600, color: MUTED };
export const deleteBtn = { border: "none", background: "none", fontSize: 16, color: "#9CA3AF", padding: "0 4px" };
