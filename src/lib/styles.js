...
export const primaryBtn = { padding: "9px 18px", borderRadius: 10, border: "none", background: `linear-gradient(135deg, ${PRIMARY}, #5849C4)`, color: "#fff", fontSize: 13.5, fontWeight: 700, whiteSpace: "nowrap" };
